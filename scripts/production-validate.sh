...
#
# 0046 creates smoke_fixture.smoke_personas — the single-row fixture table the
# smoke test writes (and rolls back). Without it the smoke test aborts with an
# actionable SMOKE ABORT instead of `42P01: relation "smoke_personas" does not
# exist`.
#
