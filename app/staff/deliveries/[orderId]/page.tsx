...
export default async function StaffDeliveryDetailPage({ params }: { params: { orderId: string } }) {
  ...
  // Only the assignee (or an admin) may execute; everyone with visibility
  // sees the read-only record.
  const canExecute =
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/staff/deliveries" className="rounded-xl border border-ink-200 p-2 text-ink-500 hover:text-ink-900">
