  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="w-full max-w-sm rounded-2xl border border-ink-100 bg-white p-8 text-center shadow-card">
        ...
        <h2 className="text-base font-semibold text-ink-950">Command Center could not load</h2>
        <p className="mt-1.5 text-sm text-ink-500">
          The business data service failed for this render. Nothing was changed — reload to retry.
        </p>
