...
/**
 * Error state for the categories list.
 *
 * The list read can fail for reasons an operator can act on (a network blip,
 * a Supabase outage, a permission change), so this offers a retry instead of
 * a silent empty table — which the old combined page rendered on failure.
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mx-auto w-full max-w-md rounded-2xl border border-rose-100 bg-white p-8 text-center shadow-card">
        ...
        <h2 className="text-base font-semibold text-ink-950">Categories could not be loaded</h2>
