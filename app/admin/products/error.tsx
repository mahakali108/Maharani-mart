...
/**
 * Error state for the product list.
 *
 * The catalog read can fail for reasons an operator can actually act on (a
 * network blip, a Supabase outage, a permission change), so this says so and
 * offers both a retry and a way out — a dead end on the catalog screen stops
 * every admin task that starts from it.
 */
