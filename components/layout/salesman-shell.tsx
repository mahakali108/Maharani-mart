...
export function SalesmanShell({
  ...
  return (
    <div className="min-h-screen bg-ink-50 pb-[calc(5rem+env(safe-area-inset-bottom))] lg:pb-0">
      ...
      <main className="mx-auto w-full min-w-0 max-w-6xl p-4 sm:p-6">{children}</main>
